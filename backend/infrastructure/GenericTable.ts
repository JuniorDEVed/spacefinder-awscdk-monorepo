...
export class GenericTable {
  ...
  public createLambdaIntagration: LambdaIntegration
  ...
  private createLambdas() {
    if (this.props.createLambdaPath) {
      ...
      this.createLambdaIntagration = new LambdaIntegration(this.createLambda)
    }
    if (this.props.readLambdaPath) {
      this.readLambda = this.createSingleLambda(this.props.readLambdaPath)
      this.createLambdaIntagration = new LambdaIntegration(this.readLambda)
    }
